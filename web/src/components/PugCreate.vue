...
<div id="container">
    <div id="content">
        <el-form ref="form" :model="form" :rules="rules" label-position="left" label-width="120px">
            ...
            <el-form-item label="Player 1 SteamID" style="width: 653px;" prop="steamids">
                <el-input v-model="form.steamids[0]"></el-input>
            </el-form-item>

            <el-form-item label="Player 2 SteamID" style="width: 653px;" prop="steamids">
                <el-input v-model="form.steamids[1]"></el-input>
            </el-form-item>

            <el-form-item label="Player 3 SteamID" style="width: 653px;" prop="steamids">
                <el-input v-model="form.steamids[2]"></el-input>
            </el-form-item>

            <el-form-item label="Player 4 SteamID" style="width: 653px;" prop="steamids">
                <el-input v-model="form.steamids[3]"></el-input>
            </el-form-item>

            <el-form-item label="Player 5 SteamID" style="width: 653px;" prop="steamids">
                <el-input v-model="form.steamids[4]"></el-input>
            </el-form-item>

            <el-form-item label="Player 6 SteamID" style="width: 653px;" prop="steamids">
                <el-input v-model="form.steamids[5]"></el-input>
            </el-form-item>

            <el-form-item label="Player 7 SteamID" style="width: 653px;" prop="steamids">
                <el-input v-model="form.steamids[6]"></el-input>
            </el-form-item>

            <el-form-item label="Player 8 SteamID" style="width: 653px;" prop="steamids">
                <el-input v-model="form.steamids[7]"></el-input>
            </el-form-item>

            <el-form-item label="Player 9 SteamID" style="width: 653px;" prop="steamids">
                <el-input v-model="form.steamids[8]"></el-input>
            </el-form-item>

            <el-form-item label="Player 10 SteamID" style="width: 653px;" prop="steamids">
                <el-input v-model="form.steamids[9]"></el-input>
            </el-form-item>
  ...
  methods: {
    async RegisterMatch () {
      ...
      this.$refs['form'].validate(async (valid) => {
        if (valid) {
          try {
            let res = await this.axios.post('/api/v1/match/create-pug', json)
            this.form = {}
            this.$message({
